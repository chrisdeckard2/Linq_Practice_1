...
internal class Program {
    ...
    static void JoinsUsingQuery() {
        ...
        foreach (var custord in CustomersOrders) {
            ...
            40, 49, 95, 67, 96, 60, 82, 56, 21, 8
        };

                var integers = (from i in ints
                                where i > 50 && i < 75 && i % 2 == 0   //&& basically AND
                                orderby i descending                   //spell out desc, if left blank its ascending
                                select i).Sum();
                ...
                //foreach(var j in integers) {    //j can be anything. Its like a place holder
                //Console.WriteLine($"{j}");
